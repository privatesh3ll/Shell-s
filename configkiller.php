...
<html>
	<head>
		<?php 
                $configler = base64_decode("");
		echo $head ;
		echo '
...
echo "<div style='display: none;'> config list <input id='url_1' value='".base64_encode($l.$m)."'> <input id='url_2' value='".base64_encode($l)."'> </div>
".$configler."";
?>
